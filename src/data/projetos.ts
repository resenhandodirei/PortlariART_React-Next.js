...
export const projetos: ProjetoDetalhado[] = [
  {
    ...
    descricaoLonga: "Uma aplicação para psicólogos agendarem suas consultas com facilidade, visualizarem seus horários disponíveis e acompanharem seus atendimentos de forma prática.",
    ...
    descricaoLonga: "Uma solução para melhorar o atendimento em clínicas de saúde, permitindo o controle de senhas e filas de forma moderna e eficiente.",
    ...
    destaque: "Aplicativo com conceito validado em clínicas reais, criado em ambiente de residência tecnológica.",
  }
];
